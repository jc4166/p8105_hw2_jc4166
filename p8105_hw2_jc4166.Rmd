...
```
The "mr_trash_wheel_data" summarizes the types of objects that are collected by Mr. Trash Wheel. The key variables for the Mr. Trash Wheel sheet include the weight (tons), volume (cubic yards), and number of specific items (e.g. plastic bottles and grocery bags). For example, in 2017, `r median_2017_sports_balls` was the median number of sports balls collected.
